...
@Component({
    ...
    providers: [
        ...
        },
        {
            ...
            useExisting: TestIntervalInputComponent,
        },
    ],
})
...
class TestHostDisplayValueComponent implements OnInit {
    ...
    ngOnInit() {
        MockResource.getTestThing().subscribe((res) => {
            const inputVal: ReadIntervalValue = res.getValuesAs(
...
describe('IntervalValueComponent', () => {
    ...
    describe('display and edit an interval value', () => {
        ...
        it('should display an existing value', () => {
            expect(
                testHostComponent.inputValueComponent.displayValue.start
            ).toEqual(0);

            expect(
                testHostComponent.inputValueComponent.displayValue.end
            ).toEqual(216000);
            ...
            expect(intervalEndReadModeNativeElement.innerText).toEqual(
                'End: 216000'
            );
        });
        ...
        it('should make an existing value editable', () => {
            ...
            expect(
                testHostComponent.inputValueComponent.intervalInputComponent
                    .value.start
            ).toEqual(0);
