...
class TestHostDisplayValueComponent implements OnInit {
    ...
    ngOnInit() {
        MockResource.getTestThing().subscribe((res) => {
            const inputVal: ReadTimeValue = res.getValuesAs(
 ...
 */
@Component({
    template: ` <app-time-value #inputVal [mode]="mode"></app-time-value>`,
})
...
describe('TimeValueComponent', () => {
    ...
    describe('display and edit a time value', () => {
        ...
        it('should display an existing value', () => {
            expect(
                testHostComponent.inputValueComponent.displayValue.time
            ...
            expect(dateReadModeNativeElement.innerText).toEqual(
                'Date: Aug 30, 2019'
            );
