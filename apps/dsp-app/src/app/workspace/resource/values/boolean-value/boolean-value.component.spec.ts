...
describe('BooleanValueComponent', () => {
    ...
    describe('display and edit a boolean value', () => {
        ...
        it('should validate an existing value with an added comment', () => {
            ...
            expect(
                testHostComponent.booleanValueComponent.form.valid
            ).toBeFalsy(); // because the booleans value did not change. it is still == true
            ...
            expect(
                testHostComponent.booleanValueComponent.form.valid
            ).toBeTruthy(); // the form is valid now, because the comments value changed
            const updatedValue =
                testHostComponent.booleanValueComponent.getUpdatedValue();
    ...
    describe('create a boolean value', () => {
        ...
        beforeEach(() => {
            ...
            expect(
                testHostComponent.booleanValueComponent.displayValue
            ).toEqual(undefined);
            expect(
                testHostComponent.booleanValueComponent.form.valid
            ).toBeTruthy();
        ...
        it('should create a value', () => {
            ...
            const newValue =
                testHostComponent.booleanValueComponent.getNewValue();
