...
describe('TextValueAsStringComponent', () => {
    ...
    describe('display and edit a text value without markup', () => {
        ...
        it('should display an existing value', () => {
            expect(
                testHostComponent.inputValueComponent.displayValue.text
            ).toEqual('test');
        ...
        it('should make an existing value editable', () => {
            ...
            expect(
                updatedValue instanceof UpdateTextValueAsString
            ).toBeTruthy();

            expect((updatedValue as UpdateTextValueAsString).text).toEqual(
                'updated text'
            );
        });
    ...
    describe('display and edit a text value and comment without markup', () => {
        ...
        it('should make an existing value editable', () => {
            ...
            expect(
                (updatedValue as UpdateTextValueAsString).valueHasComment
            ).toEqual('this is an updated comment');
        });
    ...
    describe('create a text value without markup', () => {
        ...
        it('should create a value', () => {
            ...
            expect((newValue as CreateTextValueAsString).text).toEqual(
                'created text'
            );
        });
