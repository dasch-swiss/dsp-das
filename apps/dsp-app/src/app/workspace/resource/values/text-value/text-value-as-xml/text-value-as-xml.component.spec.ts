 ...
 */
@Component({
  template: ` <app-text-value-as-xml #inputVal [mode]="mode"></app-text-value-as-xml>`,
})
...
describe('TextValueAsXMLComponent', () => {
  ...
  describe('display and edit a text value with xml markup', () => {
    ...
    it('convert markup received from CKEditor: <i> -> <em>', () => {
      ...
      expect((testHostComponent.inputValueComponent.getUpdatedValue() as UpdateTextValueAsXml).xml).toEqual(
