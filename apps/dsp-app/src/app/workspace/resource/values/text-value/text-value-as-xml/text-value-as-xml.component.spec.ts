 ...
 */
@Component({
    template: ` <app-text-value-as-xml
        #inputVal
        [displayValue]="displayInputVal"
        [mode]="mode"
        (internalLinkClicked)="standoffLinkClicked($event)"
        (internalLinkHovered)="standoffLinkHovered($event)"
    >
...
class TestHostDisplayValueComponent implements OnInit {
    ...
    ngOnInit() {
        MockResource.getTestThing().subscribe((res) => {
            this.displayInputVal = res.getValuesAs(
...
describe('TextValueAsXMLComponent', () => {
    ...
    describe('display and edit a text value with xml markup', () => {
        ...
        it('should display an existing value for the standard mapping as formatted text', () => {
            expect(
                testHostComponent.inputValueComponent.displayValue.xml
            ).toEqual(
        ...
        it('should display an existing value for the standard mapping as formatted text and react to clicking on a standoff link', () => {
            ...
            const debugElement = valueComponentDe.query(
                By.directive(TestTextValueHtmlLinkDirective)
            );

            // https://stackoverflow.com/questions/50611721/how-to-access-property-of-directive-in-a-test-host-in-angular-5/51716105
            const linkDirective = debugElement.injector.get(
                TestTextValueHtmlLinkDirective
            );
        ...
        it('should make an existing value editable', () => {
            ...
            ckeditorDe = valueComponentDe.query(
                By.directive(TestCKEditorComponent)
            );
            ...
            expect(
                testHostComponent.inputValueComponent.valueFormControl.disabled
            ).toBeFalsy();
            ...
            expect((updatedValue as UpdateTextValueAsXml).xml).toEqual(
        ...
        it('convert markup received from CKEditor: <i> -> <em>', () => {
            ...
            // simulate input in ckeditor
            ckeditorDe.componentInstance.value =
                '<p>test <i>with</i> a lot of <i>markup</i></p>';
            ckeditorDe.componentInstance._handleInput();
            ...
            expect(
                (
                    testHostComponent.inputValueComponent.getUpdatedValue() as UpdateTextValueAsXml
                ).xml
            ).toEqual(
                '<?xml version="1.0" encoding="UTF-8"?><text><p>test <em>with</em> a lot of <em>markup</em></p></text>'
            );
        });
        ...
        it('convert markup received from CKEditor: <hr> -> <hr/>', () => {
            ...
            // simulate input in ckeditor
            ckeditorDe.componentInstance.value =
                '<p>test with horizontal line <hr></p>';
            ckeditorDe.componentInstance._handleInput();
            ...
            expect(
                ...
                '<?xml version="1.0" encoding="UTF-8"?><text><p>test with horizontal line <hr/></p></text>'
            );
        });
        ...
        it('convert markup received from CKEditor: <br> -> <br/>', () => {
            ...
            expect(
                ...
                '<?xml version="1.0" encoding="UTF-8"?><text><p>test with soft break <br/></p></text>'
            );
        });
        ...
        it('convert markup received from CKEditor: <s></s> -> <strike></strike>', () => {
            ...
            expect(
                ...
                '<?xml version="1.0" encoding="UTF-8"?><text><p>test with <strike>struck</strike> word</p></text>'
            );
        });
        ...
        it('remove markup received from CKEditor: <figure class=""></figure>', () => {
            ...
            // simulate input in ckeditor
            ckeditorDe.componentInstance.value =
                '<p><figure class="table"><table><tbody><tr><td>test</td><td>test</td></tr><tr><td>test</td><td>test</td></tr></tbody></table></figure></p>';
            ckeditorDe.componentInstance._handleInput();
            ...
            expect(
                ...
                '<?xml version="1.0" encoding="UTF-8"?><text><p><table><tbody><tr><td>test</td><td>test</td></tr><tr><td>test</td><td>test</td></tr></tbody></table></p></text>'
            );
        });
    });
    ...
    describe('create a text value with markup', () => {
        ...
        it('should create a value', () => {
            ...
            expect((newValue as CreateTextValueAsXml).xml).toEqual(
                '<?xml version="1.0" encoding="UTF-8"?><text><p>created text<p></p></text>'
            );
            expect((newValue as CreateTextValueAsXml).mapping).toEqual(
                Constants.StandardMapping
            );
        });
