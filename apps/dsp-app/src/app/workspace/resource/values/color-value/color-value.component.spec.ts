 ...
 */
@Component({
    template: ` <app-color-value
        #colorVal
        [displayValue]="displayColorVal"
        [mode]="mode"
        [showHexCode]="showColorHex"
    ></app-color-value>`,
})
 ...
 */
@Component({
    template: ` <app-color-value #colorValue [mode]="mode"></app-color-value>`,
})
...
describe('ColorValueComponent', () => {
    ...
    describe('display and edit a color value', () => {
        ...
        it('should display an existing value without a hex color code', () => {
            expect(
                testHostComponent.colorValueComponent.displayValue.color
            ).toEqual('#ff3333');

            expect(
                testHostComponent.colorValueComponent.form.valid
            ).toBeTruthy();

            expect(testHostComponent.colorValueComponent.mode).toEqual('read');

            expect(
                valueReadModeNativeElement.style.backgroundColor
            ).not.toBeUndefined();
        ...
        it('should make an existing value editable', () => {
            ...
            expect(testHostComponent.colorValueComponent.mode).toEqual(
                'update'
            );
            ...
            expect(
                testHostComponent.colorValueComponent.colorPickerComponent.value
            ).toEqual('#ff3333');
            ...
            expect(
                testHostComponent.colorValueComponent.valueFormControl.value
            ).toBeTruthy();
            ...
            const updatedValue =
                testHostComponent.colorValueComponent.getUpdatedValue();
        ...
        it('should validate an existing value with an added comment', () => {
            ...
            expect(
                testHostComponent.colorValueComponent.form.valid
            ).toBeFalsy(); // because no value or comment changed

            // set a comment value
            testHostComponent.colorValueComponent.commentFormControl.setValue(
                'a comment'
            );
            testHostFixture.detectChanges();
            expect(
                testHostComponent.colorValueComponent.form.valid
            ).toBeTruthy(); // because now the comment changed
        ...
        it('should unsubscribe when destroyed', () => {
            expect(
                testHostComponent.colorValueComponent.commentChangesSubscription
                    .closed
            ).toBeFalsy();
    ...
    describe('create a color value', () => {
        ...
        it('should create a value', () => {
            ...
            const newValue =
                testHostComponent.colorValueComponent.getNewValue();
