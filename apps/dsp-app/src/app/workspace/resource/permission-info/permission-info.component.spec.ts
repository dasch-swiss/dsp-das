...
describe('PermissionInfoComponent', () => {
    ...
    it('should have permission values and an icon button', () => {
        ...
        expect(
            testHostComponent.permissionInfoComponent.hasPermissions
        ).toEqual(
            'CR knora-admin:Creator|M knora-admin:ProjectMember|V knora-admin:KnownUser|RV knora-admin:UnknownUser'
        );
        expect(
            testHostComponent.permissionInfoComponent.userHasPermission
        ).toEqual('RV');
    });
    ...
    it('should display all permissions as enabled in the first line (Creator has CR)', () => {
        ...
        const rowEle =
            permissionInfoBox.nativeElement.querySelector('tr.Creator');

        expect(rowEle.querySelector('td.first-col').innerText).toEqual(
            'Creator'
        );
        expect(
            rowEle.querySelector('td.perm-RV').querySelector('.mat-icon')
                .innerText
        ).toEqual('radio_button_checked');
        expect(
            rowEle.querySelector('td.perm-V').querySelector('.mat-icon')
                .innerText
        ).toEqual('radio_button_checked');
        expect(
            rowEle.querySelector('td.perm-M').querySelector('.mat-icon')
                .innerText
        ).toEqual('radio_button_checked');
        expect(
            rowEle.querySelector('td.perm-D').querySelector('.mat-icon')
                .innerText
        ).toEqual('radio_button_checked');
        expect(
            rowEle.querySelector('td.perm-CR').querySelector('.mat-icon')
                .innerText
        ).toEqual('radio_button_checked');
    });
