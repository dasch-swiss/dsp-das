...
class TestHostDisplayValueComponent implements OnInit {
    ...
    displayEditValueComponent: DisplayEditComponent;
...
describe('DisplayEditComponent', () => {
    ...
    describe('display a value with the appropriate component', () => {
        ...
        it('should react to clicking on a standoff link', () => {
            ...
            expect(
                (testHostComponent.linkValClicked as ReadLinkValue)
                    .linkedResourceIri
            ).toEqual('testIri');
        });
        ...
        it('should react to hovering on a standoff link', () => {
            ...
            expect(
                (testHostComponent.linkValHovered as ReadLinkValue)
                    .linkedResourceIri
            ).toEqual('testIri');
        });
        ...
        it('should choose the apt component for an integer value in the template', () => {
            ...
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.displayValue instanceof ReadIntValue
            ).toBe(true);
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.mode
        ...
        it('should choose the apt component for a URI value in the template', () => {
            ...
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.displayValue instanceof ReadUriValue
            ).toBe(true);
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.mode
        ...
        it('should choose the apt component for a time value in the template', () => {
            ...
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.displayValue instanceof ReadTimeValue
            ).toBe(true);
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.mode
        ...
        it('should choose the apt component for a link value in the template', () => {
            ...
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.displayValue instanceof ReadLinkValue
            ).toBe(true);
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.mode
        ...
        it('should choose the apt component for a link value (standoff link) in the template', () => {
            ...
            testHostComponent.readValue.property =
        ...
        it('should choose the apt component for a list value in the template', () => {
            ...
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.displayValue instanceof ReadListValue
            ).toBe(true);
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.mode
    ...
    describe('change from display to edit mode', () => {
        ...
        it('should switch to edit mode when the edit button is clicked', () => {
            ...
            const editButtonNativeElement =
                editButtonDebugElement.nativeElement;
            ...
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.form.valid
            ).toBeFalsy();
        ...
        it('should save a new version of a value', () => {
            ...
            expect(
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.displayValue.id
            ).toEqual('newID');
            expect(testHostComponent.displayEditValueComponent.mode).toEqual(
                'read'
            );
        });
        ...
        it('should handle an ApiResponseError with status of 400 correctly', () => {
            ...
            const formErrors =
                testHostComponent.displayEditValueComponent
                    .displayValueComponent.valueFormControl.errors;
    ...
    describe('deleteValue method', () => {
        ...
        it('should delete a value from a property', async () => {
            ...
            testHostFixture.whenStable().then(() => {
                ...
                expect(valuesSpy.v2.values.deleteValue).toHaveBeenCalledTimes(
                    1
                );
