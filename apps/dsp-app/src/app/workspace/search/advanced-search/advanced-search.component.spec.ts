 ...
 */
@Component({
    template: ` <app-advanced-search #advSearch></app-advanced-search>`,
})
...
describe('AdvancedSearchComponent', () => {
    ...
    describe('Ontology with resources', () => {
        beforeEach(() => {
            ...
            ).getOntologiesMetadata.and.callFake(() => {
        ...
        it('should get ontologies metadata on init', () => {
            ...
            expect(
                testHostComponent.advancedSearch.ontologiesMetadata
            ).toBeDefined();
            expect(
                testHostComponent.advancedSearch.ontologiesMetadata.ontologies
                    .length
            ).toEqual(1);

            const hostCompDe = testHostFixture.debugElement;
            const selectOntoComp = hostCompDe.query(
                By.directive(TestSearchSelectOntologyComponent)
            );

            expect(
                (
                    selectOntoComp.componentInstance as TestSearchSelectOntologyComponent
                ).ontologiesMetadata
            ).toBeDefined();
            expect(
                (
            ...
            expect(
                dspConnSpy.v2.onto.getOntologiesMetadata
        ...
        it('should set the active ontology when an ontology is selected', () => {
            ...
            expect(testHostComponent.advancedSearch.activeOntology).toEqual(
                'http://0.0.0.0:3333/ontology/0001/anything/v2'
            );

            expect(
                testHostComponent.advancedSearch.resourceAndPropertySelection
                    .activeOntology
