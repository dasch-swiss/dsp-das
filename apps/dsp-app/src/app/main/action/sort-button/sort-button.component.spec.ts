...
describe('SortButtonComponent', () => {
    ...
    it('should sort the list by lastname', () => {
        ...
        expect(
            sortSelectionEl.items._results[0]._elementRef.nativeElement
                .innerText
        ).toEqual('First name');
        expect(
            sortSelectionEl.items._results[1]._elementRef.nativeElement
                .innerText
        ).toEqual('Last name');
        expect(
            sortSelectionEl.items._results[2]._elementRef.nativeElement
                .innerText
        ).toEqual('Creator');
