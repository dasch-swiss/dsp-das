...
@Component({
    template:
        '<app-edit-list-item #editListItem [iri]="iri" [mode]="mode" [projectIri]="projectIri"></app-edit-list-item>',
})
...
@Component({
    template:
        '<app-edit-list-item #editListItem [iri]="iri" [mode]="mode" [parentIri]="parentIri" [position]="position" [projectIri]="projectIri"></app-edit-list-item>',
})
    ...
    describe('update list child node', () => {
        ...
        it('should update labels when the value changes', () => {
            ...
            testHostComponent.editListItem.handleData(
                [
                    { value: 'Tree list node 01', language: 'en' },
                    { value: 'Baumlistenknoten 01', language: 'de' },
                ],
                'labels'
            );
            expect(testHostComponent.editListItem.labels).toEqual([
            ...
            expect(
                testHostComponent.editListItem.saveButtonDisabled
            ).toBeFalsy();
        ...
        it('should update the child node info', () => {
            ...
            updateChildNodeRequest.labels =
                testHostComponent.editListItem.labels;
            updateChildNodeRequest.comments =
                testHostComponent.editListItem.comments;
        ...
        it('should delete the child node comments', () => {
            ...
            (
                ...
                expect(testHostComponent.editListItem.comments.length).toEqual(
                    0
                );
    ...
    describe('insert list child node', () => {
        ...
        it('should create (insert) a new child node', () => {
            ...
            (
                ...
                response.nodeinfo.id =
                    'http://rdfh.ch/lists/0001/otherTreeList0123';
                response.nodeinfo.labels = [
                    { value: 'My new child node value', language: 'en' },
                ];
                response.nodeinfo.comments = [
            ...
            createChildNodeRequest.projectIri =
                testHostComponent.editListItem.projectIri;
            createChildNodeRequest.labels =
                testHostComponent.editListItem.labels;
            createChildNodeRequest.comments =
                testHostComponent.editListItem.comments;
            createChildNodeRequest.position =
                testHostComponent.editListItem.position;
