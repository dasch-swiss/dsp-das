...
export class ResourceClassFormComponent implements OnInit, AfterViewChecked {
    ...
    handleError(touched: boolean, type: 'label' | 'comment') {
        const checkValue =
            type === 'label'
                ? this.resourceClassLabels
                : this.resourceClassComments;
    ...
    submitData() {
        ...
        if (this.edit) {
            ...
            // comment
            const onto4Comment =
                new UpdateOntology<UpdateResourceClassComment>();
                ...
                .subscribe(
                    (
                        ...
                        this.lastModificationDate =
                            classLabelResponse.lastModificationDate;
                        ...
                        if (updateComment.comments.length) {
                            ...
                            const deleteResourceClassComment =
                                new DeleteResourceClassComment();
            ...
            this._dspApiConnection.v2.onto.createResourceClass(onto).subscribe(
                (classResponse: ResourceClassDefinitionWithAllLanguages) => {
                    ...
                    this.lastModificationDate =
                        classResponse.lastModificationDate;
                    // close the dialog box
                    this.loading = false;
                    this.closeDialog.emit();
                },
