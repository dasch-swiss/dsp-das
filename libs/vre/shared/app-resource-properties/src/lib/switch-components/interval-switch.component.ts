...
@Component({
  ...
  template: `
    ...
    <ng-template #editMode>
      <app-common-input placeholder="start" [control]="control.controls.start" type="number" data-cy="start-input" />
      <app-common-input placeholder="end" [control]="control.controls.end" type="number" data-cy="end-input" />
    </ng-template>
  `,
})
