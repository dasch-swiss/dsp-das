...
import {
    ...
    UpdateDefaultObjectAccessPermission, UpdateDefaultObjectAccessPermissionProperty,
...
export class PermissionApiService extends BaseApi {
    ...
    updateAdministrativePermission(permissionIri: string, permisssion: UpdateAdministrativePermission) {
        ...
        return this._http.put<AdministrativePermissionResponse>(`${this.baseUri}/${encodeURIComponent(permissionIri)}/hasPermissions`, permisssion);
    }

    updateAdministrativePermissionGroup(permissionIri: string, updatedGroup: UpdateAdministrativePermissionGroup) {
        // TODO from name, it should be in admin-permission-api.service.ts, but from route it is in the right place.
        return this._http.put<AdministrativePermissionResponse>(`${this.baseUri}/${encodeURIComponent(permissionIri)}/group`, updatedGroup);
    }

    getDefaultObjectAccessPermissions(projectIri: string) {
        return this._http.get<DefaultObjectAccessPermissionsResponse>(`${this.baseUri}/doap/${encodeURIComponent(projectIri)}`);
    }
    ...
    updateDefaultObjectAccessPermission(permissionIri: string, permission: UpdateDefaultObjectAccessPermission) {
        ...
        return this._http.put<DefaultObjectAccessPermissionResponse>(`${this.baseUri}/${encodeURIComponent(permissionIri)}/hasPermissions`,permission);
    }

    updateDefaultObjectAccessPermissionGroup(permissionIri: string, permission: UpdateDefaultObjectAccessPermission) {
        // TODO route should be replaced by /doap
        return this._http.put<DefaultObjectAccessPermissionResponse>(`${this.baseUri}/${encodeURIComponent(permissionIri)}/group`,permission);
    }

    updateDefaultObjectAccessPermissionResourceClass(permissionIri: string, permission: UpdateDefaultObjectAccessPermissionResourceClass) {
        // TODO route should be replaced by /doap
        return this._http.put<DefaultObjectAccessPermissionResponse>(`${this.baseUri}/${encodeURIComponent(permissionIri)}/resourceClass`,permission);
    }

    updateDefaultObjectAccessPermissionProperty(permissionIri: string, permission: UpdateDefaultObjectAccessPermissionProperty) {
        // TODO route should be replaced by /doap
        return this._http.put<DefaultObjectAccessPermissionResponse>(`${this.baseUri}/${encodeURIComponent(permissionIri)}/property`,permission);
    }
