...
export class AdminProjectsApiService {
     ...
     * @param knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999 
     * @param keepAssets If set to true the assets in ingest will not be removed.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public deleteAdminProjectsShortcodeProjectshortcodeErase(projectShortcode: string, knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999?: string, keepAssets?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ProjectOperationResponseADM>;
    public deleteAdminProjectsShortcodeProjectshortcodeErase(projectShortcode: string, knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999?: string, keepAssets?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ProjectOperationResponseADM>>;
    public deleteAdminProjectsShortcodeProjectshortcodeErase(projectShortcode: string, knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999?: string, keepAssets?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ProjectOperationResponseADM>>;
    public deleteAdminProjectsShortcodeProjectshortcodeErase(projectShortcode: string, knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999?: string, keepAssets?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (projectShortcode === null || projectShortcode === undefined) {
            throw new Error('Required parameter projectShortcode was null or undefined when calling deleteAdminProjectsShortcodeProjectshortcodeErase.');
        }

        let localVarQueryParameters = new HttpParams({encoder: this.encoder});
        if (keepAssets !== undefined && keepAssets !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>keepAssets, 'keepAssets');
        }
        ...
        let localVarPath = `/admin/projects/shortcode/${this.configuration.encodeParam({name: "projectShortcode", value: projectShortcode, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/erase`;
        return this.httpClient.request<ProjectOperationResponseADM>('delete', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param projectCreateRequest The property &#x60;enabledLicenses&#x60; is optional. If not provided, the DaSCH recommended licenses will be used. The property &#x60;allowedCopyrightHolders&#x60; is optional. The copyright holder for AI generated values and unknown authorship will be added in any case.
     * @param knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postAdminProjectsShortcodeProjectshortcodeExportAwait(projectShortcode: string, knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ProjectExportInfoResponse>;
    public postAdminProjectsShortcodeProjectshortcodeExportAwait(projectShortcode: string, knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ProjectExportInfoResponse>>;
    public postAdminProjectsShortcodeProjectshortcodeExportAwait(projectShortcode: string, knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ProjectExportInfoResponse>>;
    public postAdminProjectsShortcodeProjectshortcodeExportAwait(projectShortcode: string, knoraAuthenticationMFYGSLTEMV3C4ZDBONRWQLTTO5UXG4Z2GQ2DG999?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (projectShortcode === null || projectShortcode === undefined) {
            throw new Error('Required parameter projectShortcode was null or undefined when calling postAdminProjectsShortcodeProjectshortcodeExportAwait.');
        }
        ...
        let localVarPath = `/admin/projects/shortcode/${this.configuration.encodeParam({name: "projectShortcode", value: projectShortcode, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/export-await`;
        return this.httpClient.request<ProjectExportInfoResponse>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
