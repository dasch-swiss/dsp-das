...
// @ts-ignore
import { ProjectLicenseDto } from '../model/project-license-dto';
...
export class AdminProjectsLegalInfoApiService {
    ...
    /**
     * Get a specific license by its IRI for use within this project.
     * @param projectShortcode The shortcode of a project. Must be a 4 digit hexadecimal String.
     * @param licenseIri The IRI of the license. Must be URL-encoded.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getAdminProjectsShortcodeProjectshortcodeLegalInfoLicensesLicenseiri(projectShortcode: string, licenseIri: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ProjectLicenseDto>;
    public getAdminProjectsShortcodeProjectshortcodeLegalInfoLicensesLicenseiri(projectShortcode: string, licenseIri: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ProjectLicenseDto>>;
    public getAdminProjectsShortcodeProjectshortcodeLegalInfoLicensesLicenseiri(projectShortcode: string, licenseIri: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ProjectLicenseDto>>;
    public getAdminProjectsShortcodeProjectshortcodeLegalInfoLicensesLicenseiri(projectShortcode: string, licenseIri: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (projectShortcode === null || projectShortcode === undefined) {
            throw new Error('Required parameter projectShortcode was null or undefined when calling getAdminProjectsShortcodeProjectshortcodeLegalInfoLicensesLicenseiri.');
        }
        if (licenseIri === null || licenseIri === undefined) {
            throw new Error('Required parameter licenseIri was null or undefined when calling getAdminProjectsShortcodeProjectshortcodeLegalInfoLicensesLicenseiri.');
        }
        ...
        return this.httpClient.request<ProjectLicenseDto>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
