...
export class AdminListsApiService {
     ...
     * @param projectShortcode The (optional) shortcode of the project.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getAdminLists(projectIri?: string, projectShortcode?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ListsGetResponseADM>;
    public getAdminLists(projectIri?: string, projectShortcode?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ListsGetResponseADM>>;
    public getAdminLists(projectIri?: string, projectShortcode?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ListsGetResponseADM>>;
    public getAdminLists(projectIri?: string, projectShortcode?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (projectShortcode !== undefined && projectShortcode !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>projectShortcode, 'projectShortcode');
        }
