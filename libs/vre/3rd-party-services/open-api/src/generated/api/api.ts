...
export const APIS = [AdminFilesApiService, AdminGroupsApiService, AdminListsApiService, AdminMaintenanceApiService, AdminPermissionsApiService, AdminProjectsApiService, AdminStoreApiService, AdminUsersApiService, DefaultApiService, ShaclApiService, V2ApiService, V2ResourcesApiService, V2SearchApiService];
