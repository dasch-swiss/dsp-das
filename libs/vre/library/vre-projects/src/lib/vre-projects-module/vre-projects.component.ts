 ...
 */
@Component({
    selector: 'app-vre-projects',
    templateUrl: './vre-projects.component.html',
    styleUrls: ['./vre-projects.component.scss'],
})
export class VreProjectsComponent implements OnInit {
    /**
