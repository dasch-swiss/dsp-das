...
@Component({
    selector: 'app-vre-projects-list',
    templateUrl: './vre-projects-list.component.html',
    styleUrls: ['./vre-projects-list.component.scss'],
})
export class VreProjectsListComponent implements OnInit {
    ...
    editing = false; // if one of the projects is selected for editing
