...
import { VreProjectsComponent } from './projects.component';
...
describe('ProjectsComponent', () => {
    let component: VreProjectsComponent;
    let fixture: ComponentFixture<VreProjectsComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(VreProjectsComponent);
