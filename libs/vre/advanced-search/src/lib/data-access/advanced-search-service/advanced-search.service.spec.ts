...
describe('AdvancedSearchService', () => {
  ...
  describe('properties', () => {
      ...
      service.propertiesList(ontologyIri).subscribe(properties => {
        expect(properties).toEqual([
          ...
          },
          {
            ...
            isLinkedResourceProperty: false,
            listIri: 'http://rdfh.ch/lists/0420/6-Vp0F_1TfSS-DS_9q-Ucw',
          },
        ]);
        done();
      });
    ...
    it('should return a list of properties filtered by resource class', done => {
      ...
      // Mock the API call using a mock value
      const mockOntologyCache = {
        getResourceClassDefinition: jest.fn().mockReturnValue(of(ontology)),
      };
      ...
      service.filteredPropertiesList(resourceClassIri).subscribe(properties => {
        expect(properties).toEqual([
          {
            iri: 'prop1',
            label: 'Property 1',
  ...
  describe('resource search', () => {
    ...
    it('should return a list of resources', done => {
      ...
      // Mock the API call using a mock value
      const mockSearchService = {
        doSearchByLabel: jest.fn().mockReturnValue(of(mockResourceSequence)),
      };
