...
import {
  ...
  AddRegionFormDialogProps,
} from '../../representation/add-region-form-dialog.component';
import { Region } from '../../representation/region';
...
export class OsdDrawerService implements OnDestroy {
  ...
  onInit(resource: ReadResource): void {
    ...
    this._osd.viewer.addHandler('canvas-click', (event: OpenSeadragon.CanvasClickEvent) => {
      ...
      const target = event.originalTarget as unknown as SVGElement;
