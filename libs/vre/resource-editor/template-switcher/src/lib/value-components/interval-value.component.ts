...
@Component({
  ...
  template: `
    <app-time-input [label]="'resourceEditor.templateSwitcher.intervalValue.start' | translate" [control]="startControl" data-cy="start-input" />
    <app-time-input [label]="'resourceEditor.templateSwitcher.intervalValue.end' | translate" [control]="endControl" data-cy="end-input" />
