...
describe('Instantiate a calendar date from a calendar period', () => {
  it('create a Gregorian date from an exact calendar period', () => {
    const gregorianCalendarDate: GregorianCalendarDate = new GregorianCalendarDate(
      new CalendarPeriod(new CalendarDate(2018, 7, 26), new CalendarDate(2018, 7, 26))
    );
  ...
  it('create a Gregorian date from a calendar period', () => {
    const gregorianCalendarDate: GregorianCalendarDate = new GregorianCalendarDate(
      new CalendarPeriod(new CalendarDate(2018, 7, 26), new CalendarDate(2018, 7, 27))
    );
  ...
  it('create an Islamic date from an exact calendar period', () => {
    const islamicCalendarDate: IslamicCalendarDate = new IslamicCalendarDate(
      new CalendarPeriod(new CalendarDate(1439, 11, 3), new CalendarDate(1439, 11, 13))
    );
  ...
  it('create an Islamic date from an exact calendar period', () => {
    const islamicCalendarDate: IslamicCalendarDate = new IslamicCalendarDate(
      new CalendarPeriod(new CalendarDate(1438, 12, 3), new CalendarDate(1439, 1, 13))
    );
  ...
  it('create an Islamic date from an exact calendar period in a leap year', () => {
    const islamicCalendarDate: IslamicCalendarDate = new IslamicCalendarDate(
      new CalendarPeriod(new CalendarDate(1434, 12, 3), new CalendarDate(1435, 1, 13))
    );
