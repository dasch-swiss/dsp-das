    ...
    it('should route to Angular Material page', async () => {
        ...
        browser.getWindowHandle().then(function (parentGUID) {
            ...
            browser.getAllWindowHandles().then(function (allGUID) {
                ...
                // perform here any actions needed on the new tab
                expect(browser.driver.getCurrentUrl()).toEqual('https://material.angular.io');
    ...
    it('should route to DSP-API doc page', async () => {
        ...
        browser.getWindowHandle().then(function (parentGUID) {
            ...
            browser.getAllWindowHandles().then(function (allGUID) {
                ...
                // perform here any actions needed on the new tab
                expect(browser.driver.getCurrentUrl()).toEqual('https://www.knora.org');
    ...
    it('should route to Sipi page', async () => {
        ...
        browser.getWindowHandle().then(function (parentGUID) {
            ...
            browser.getAllWindowHandles().then(function (allGUID) {
                ...
                // perform here any actions needed on the new tab
                expect(browser.driver.getCurrentUrl()).toEqual('https://sipi.io');
    ...
    it('should route to SAGW page', async () => {
        ...
        browser.getWindowHandle().then(function (parentGUID) {
            ...
            browser.getAllWindowHandles().then(function (allGUID) {
                ...
                // perform here any actions needed on the new tab
                expect(browser.driver.getCurrentUrl()).toEqual('http://sagw.ch');
    ...
    it('should route to SwissUniversities page', async () => {
        ...
        browser.getWindowHandle().then(function (parentGUID) {
            ...
            browser.getAllWindowHandles().then(function (allGUID) {
                ...
                // perform here any actions needed on the new tab
                expect(browser.driver.getCurrentUrl()).toEqual('http://swissuniversities.ch');
    ...
    it('should route to DaSCH github page', async () => {
        ...
        browser.getWindowHandle().then(function (parentGUID) {
            ...
            browser.getAllWindowHandles().then(function (allGUID) {
                ...
                // perform here any actions needed on the new tab
                expect(browser.driver.getCurrentUrl()).toEqual('https://www.github.com/dasch-swiss');
    ...
    it('should route to DaSCH twitter page', async () => {
        ...
        browser.getWindowHandle().then(function (parentGUID) {
            ...
            browser.getAllWindowHandles().then(function (allGUID) {
                ...
                // perform here any actions needed on the new tab
                expect(browser.driver.getCurrentUrl()).toEqual('https://twitter.com/DaSCHSwiss');
    ...
    it('should route to DaSCH facebook page', async () => {
        ...
        browser.getWindowHandle().then(function (parentGUID) {
            ...
            browser.getAllWindowHandles().then(function (allGUID) {
                ...
                // perform here any actions needed on the new tab
                expect(browser.driver.getCurrentUrl()).toEqual('https://facebook.com/dasch.swiss');
