...
@Component({
    template: `
        <app-progress-indicator #progressIndicator [status]="status" [color]="color"></app-progress-indicator>`
})
...
describe('ProgressIndicatorComponent', () => {
    ...
    it('should update the progress indicator according to the status value', () => {
        ...
        // new status: done
        expect(matIconEl.attributes.class).toEqual('mat-icon notranslate after-submit material-icons mat-ligature-font mat-icon-no-color');
