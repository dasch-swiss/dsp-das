...
@Component({
    template: `
        <button mat-menu-item [matMenuTriggerFor]="menu.childMenu" type="button" class="menubutton">
            {{child.label}}
        </button>
        <app-search-display-list #menu [children]="child.children" (selectedNode)="getSelectedNode($event)">
