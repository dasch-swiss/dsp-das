...
@Component({
    template: `
    <app-list-value #inputVal [displayValue]="displayInputVal" [mode]="mode" [propertyDef]="propertyDef"></app-list-value>`
})
...
@Component({
    template: `
    <app-list-value #inputVal [mode]="mode" [propertyDef]="propertyDef"></app-list-value>`
})
