...
@Component({
    template: `
    <app-text-value-as-string #inputVal [displayValue]="displayInputVal" [mode]="mode"></app-text-value-as-string>`
})
...
@Component({
    template: `
    <app-text-value-as-string #inputVal [mode]="mode"></app-text-value-as-string>`
})
