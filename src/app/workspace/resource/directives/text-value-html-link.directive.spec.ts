...
@Component({
    template: `
        <div [innerHTML]="html" appHtmlLink (internalLinkClicked)="clicked($event)" (internalLinkHovered)="hovered($event)"></div>`
})
class TestHostComponent {

    // the href attribute of the external link is empty
    // because otherwise the test browser would attempt to access it
    html = 'This is a test <a>external link</a> and a test <a class="salsah-link" href="http://rdfh.ch/0001/H6gBWUuJSuuO-CilHV8kQw">internal link</a>';
