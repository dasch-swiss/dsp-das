...
export const options = {
  ...
  thresholds: {
    ...
    'store_state_update_latency': ['avg<500'], // State updates under 500ms
    'store_memory_growth': ['avg<10485760'], // Memory growth under 10MB
    'store_component_render_time': ['avg<200'], // Component renders under 200ms
    'store_subscription_efficiency': ['rate>0.8'], // 80%+ subscription efficiency
    'store_bootstrap_time': ['avg<3000'], // App bootstrap under 3s
  },
};
